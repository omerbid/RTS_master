...
מסמכים חדשים משתקפים **בהוספות בלבד** – לא בהחלפת קוד קיים (extend, don’t replace).
...
# 2. מבנה תיקיות בפרויקט

/Docs/  
/Docs/AI_Knowledge/

(מבנה זה נוצר ומולא לפי rts_docs_structure_for_cursor.)
...
מסמכי ארכיטקטורה ומפת מערכת → /Docs/AI_Knowledge/
